...
Progress: 14/22 findings completed.
...
- [x] A06: Validate alternatives under request constraints (SP.02).
- [x] A07: Anchor recurrence weeks to Monday (SP.06).
- [x] A08: RFC recurrence gaps and rule validation (SP.06).
...
- [x] A13: Consistent public input validation (SP.02).
- [x] A14: Closed-day overrides suppress overnight spill (SP.03).
