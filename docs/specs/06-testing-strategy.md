...
3. **Property tests** (StreamData) — the interval algebra laws from Spec 03 §1:
   - `overlaps?/2` symmetry
   ...
   - assembly/validation buffer equivalence (Spec 03 §6): inflating busy at
